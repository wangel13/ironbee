...
const ProjectCard = ({
  ...
  return (
    <Link href={`projects/${id}`}>
      <div className="bg-white p-10 rounded-lg shadow h-full hover:shadow-lg transition-all">
        <div className="text-sm text-slate-400 font-bold">{`проект в отрасли`}</div>
        ...
        <div className="text-slate-800 rounded-xl text-xl font-bold mt-4">
          {formatPriceRange(maxCost)}
        </div>
      </div>
    </Link>
  );
